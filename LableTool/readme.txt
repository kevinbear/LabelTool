Label_Maker : A Tool for create the label applicate on Object detection
...
Dependencies/需要套件 : anaconda 5.1 (python 3.6)

Download/下載 :________

How to use/如何使用:
	1. 接著ImageDisplay的畫面上會載入資料及的第一張圖片,以下會介紹Label_Maker的畫面與控制方式與按鈕功能
		(1)ImageDisplay分為三大部分：
			一、輸入路徑載入：
			...
			二、顯示：
				(1)畫布：顯示圖片畫面與邊界匡的位置
				(2)(Image Name:________.___(_/_))：顯示目前圖片
				(3)(x:__,y:__)：顯示鼠標位置
			三、圖片位移控制：
				(1)<<Prev:前一頁
				(2)Next>>：下一頁
				(3)(Image No.:)(Jump)：直接跳躍至第幾張圖片
		(2)Attribute Options分為四大部分：
			一、基本圖片資料：
				(1)Size:圖片 w x h
